...
app.controller('friendControl', function($scope) {
	...
	$scope.putIn;
//Here is the code for the option thing. BELOW VVvvVV
	// $scope.filterOptions = {
	// 	{value: "friend_count", lable= "# friends"},
 //        {value: "current_location.city", lable =  "City"},
 //        {value: "current_location.state", lable = "State"},
 //        {value: "current_location.country", lable = "Country"}
